...
def test_process_request_clamps_negative_epsilon_segment_start_time() -> None:
...
def test_self_mic_batches_bypass_long_sliding_window_and_stay_batch_relative() -> None:
    pipeline = DummyPipeline()
    processor = AudioBatchProcessor(
        settings=WorkerSettings(
            use_real_models=False,
